    ...
    const defineview=()=>{
        ...
        if (props.type===2 || props.type==5 || props.type==6){
         ...
         if (props.type===3){
            ...
            return <div>
                 <ChartView y1={props.y1} y2={props.y2}  type={"line"} name={props.name} setContent={setContent}/>
                <div className={"csubtitle-footnote"}>Τουρκία:Έτος αναφοράς υπολογισμών το 2012</div>
                 <div className={"csubtitle-footnote"}>Λιχτενστάιν: Έτος αναφοράς υπολογισμών το 2011</div>
             </div>
        }
        if (props.type===4){
        ...
        if (props.type===7){
            ...
            return <MapDisplayer year={props.year} map_download={map_download} setmapdownload={setmapdownload} name={props.name} setContent={setContent}/>
